...
<head>
    ...
    <nav class="navbar navbar-expand-xxl navbar-light bg-light"> <a class="navbar-brand" href="https://premiocalidadaps.com.co/"><img src="{{asset('logominisalud.png')}}" alt=""></a>       
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item mx-2 py-2">
                <button type="button" class="btn-an" style="background-color:#006799; color:white ">
                <a href="https://app.premiocalidadaps.com.co/Premio_nacional_OES/Evaluadores/analitica">Analitica</a>
                </button>
                </li>   
                @auth
                <li class="nav-item mx-2 py-2">
        ...
        <div class="form">
            ...
            <br>
                ...
                <a href="https://app.premiocalidadaps.com.co/Premio_nacional_OES/Evaluadores/register" class=" button-home-a">Registrar usuario</a>
                    ...
                    <a href="https://app.premiocalidadaps.com.co/Premio_nacional_OES/Evaluadores/analitica" class=" button-home-a">Analitica Completa</a>
                    ...
                    <br>
                    <a href="https://app.premiocalidadaps.com.co/Premio_nacional_OES/Evaluadores/log" class=" button-home-a">Decargar Log</a>
                </div>
