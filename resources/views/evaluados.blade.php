...
<center><h1 style="color: #009FE3">Evaluados</h1></center>
          ...
          @if (auth()->user()->Tipo_Usuario==1)
            <center>
                <a href="/exportarEvaluados" class="button-home-export">Exportar excel</a>
            </center>
        @endif  
        <br><br>
          ...
          <table class="table table-striped container-table tabla-resp">
            @if ($rf->Cinturon =="Blanco")
                <tr class="evaluados">              
                    ...
                    <th>
                        <img class="imagen-cinturon" src="{{asset('blanco2.png')}}" alt="">
                    </th>
                    <th></th>
                    <th></th>
                    <th></th>
            ...
            @elseif ($rf->Cinturon=="Amarillo")
                <tr class="evaluados">
                        ...
                        <th><img class="imagen-cinturon" src="{{asset('amarillo.png')}}" alt=""></th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>
            @elseif ($rf->Cinturon=="Verde")
                <tr class="evaluados">
                        <th>
                            Cinturon: 
                        </th>
                        ...
                        <th><img class="imagen-cinturon" src="{{asset('verde.png')}}" alt=""></th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>
                @elseif ($rf->Cinturon=="Negro")
                <tr class="evaluados">
                        <th>
                            Cinturon: 
                        </th>
                        ...
                        <th><img class="imagen-cinturon" src="{{asset('negro.png')}}" alt=""></th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>      
