...
class AutorizacionController extends Controller
{
    public function index($codigo){
        if(Auth::check()){
            if(auth()->user()->Tipo_Usuario==1){
                ...
                Log::info("Ingreso a autorizacion el Administrador: ".auth()->user()->Usuario);
    ...
    public function autorizar($id){
        if(Auth::check()){
            if(auth()->user()->Tipo_Usuario==1){
                ...
                Log::info("Ingreso a autorizacion de categoria el Administrador: ".auth()->user()->Usuario);
    ...
    public function autorizarEdit(AutorizacionRequest $request, $id){
        ...
        Log::info("Autorizacion de categoria por el Administrador: ".auth()->user()->Usuario." a la evaluacion ".$id);
